...
type Memory struct {
	...
	Unit                 Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=otakutech.pcbook.Memory_Unit" json:"unit,omitempty"`
...
func init() {
	proto.RegisterEnum("otakutech.pcbook.Memory_Unit", Memory_Unit_name, Memory_Unit_value)
	proto.RegisterType((*Memory)(nil), "otakutech.pcbook.Memory")
}
...
var fileDescriptor_c0c7f919ccc765da = []byte{
	...
	0x17, 0x12, 0xc8, 0x2f, 0x49, 0xcc, 0x2e, 0x2d, 0x49, 0x4d, 0xce, 0xd0, 0x2b, 0x48, 0x4e, 0xca,
	...
	0xc7, 0xe6, 0xc4, 0x12, 0xc5, 0x54, 0x90, 0x94, 0xc4, 0x06, 0xf6, 0x92, 0x31, 0x20, 0x00, 0x00,
	0xff, 0xff, 0x87, 0x19, 0xc7, 0x64, 0xea, 0x00, 0x00, 0x00,
}
